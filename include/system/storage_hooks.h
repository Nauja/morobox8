...
#define MOROBOX8_STORAGE_HOOKS_LIST(macro) \
    ...
    macro(read, size_t, struct morobox8_storage *storage MOROBOX8_COMMA struct morobox8_file* file MOROBOX8_COMMA morobox8_u32 address MOROBOX8_COMMA void* buf MOROBOX8_COMMA morobox8_u32 size, storage MOROBOX8_COMMA file MOROBOX8_COMMA address MOROBOX8_COMMA buf MOROBOX8_COMMA size, FALSE) \
